const TOGGLE_X_VELOCITY = 15; // Velocidade de movimento do Toggle (mais lento que o Barry)
...
class Toggle {
  ...
  // Desenha o frame correto do Toggle
  draw(context) {
  ...
  // Atualiza a posição e direção do Toggle
  update(deltaTime) {
    if (!deltaTime) return;
