...
export class Player extends Sprite {
    constructor() {
        ...
        this.animations = {
            idle: { src: "./Sprite Pack 8/2 - Tracy/Idle_1 (32 x 32).png", frames: 5, interval: 100 },
            run: { src: "./Sprite Pack 8/2 - Tracy/Run (32 x 32).png", frames: 6, interval: 80 },
            jump: { src: "./Sprite Pack 8/2 - Tracy/Jump (32 x 32).png", frames: 1, interval: 100 },
            fall: { src: "./Sprite Pack 8/2 - Tracy/Falling (32 x 32).png", frames: 1, interval: 100 },
            attack: { src: "./Sprite Pack 8/2 - Tracy/Standing_Crossbow_Shot (32 x 32).png", frames: 4, interval: 50 },
            reload: { src: "./Sprite Pack 8/2 - Tracy/Reloading_Crossbow (32 x 32).png", frames: 16, interval: 40 },
        };
